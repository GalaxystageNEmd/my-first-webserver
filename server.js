// 1. เรียกใช้งาน Module ที่ชื่อว่า 'http' ซึ่งเป็นระบบพื้นฐานของ Node.js สําหรับทําเซิร์ฟเวอร์
 ...
 // 3. สร้างเครื่องแม่ขยาย (Server) ที่คอยรับคําขอ (req) และตอบกลับ (res)
...
res.end('<h1>สวัสดีครับ! นี่คือ Web Server ของ นายคิริกายะ คาซึโตะ รหัสนักศึกษา 69319010202 </h1><p>เครื่องแม่ข่ายทํางานปกติบนระบบ Railway แล้วครับผม!</p>');
 });

 // 4. สั่งให้เซิร์ฟเวอร์เริ่มตอนเปิดรับฟองการเชื่อมต่อตาม Port ที่กําหนดไว้
 server.listen(port, () => {
